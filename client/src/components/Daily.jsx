...
export default function Daily({ dailyOpen, setDailyOpen }) {
  ...
  const editList = userData?.savedtaskslist.find(
        ...
        <>
          ...
          <div>
            ...
            >
              ...
              <select
                className="border-2 lg:w-50 w-40 border-white p-2 rounded-2xl mini-animation"
                name=""
                id=""
                onChange={(e) => {
        ...
        <>
          <div className="w-full h-full flex items-center justify-center">
            <button
              ...
              className="next-button h-12 rounded-lg z-10 hover:bg-[#493f33] mt-3"
            >
              Login first!{" "}
            </button>
          </div>
